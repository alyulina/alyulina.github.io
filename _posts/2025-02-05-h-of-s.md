...
<sup>4</sup> Specifically, reinstating the mutant lineage in this way changes the overall normalization constant of the distribution $$p(f)$$, but does not alter its shape.</sub>      
