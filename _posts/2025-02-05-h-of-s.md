...
$$ p(f) df \sim \int N\mu dt \cdot \frac{1}{t} \cdot \frac{N}{t} \sim \frac{N\mu}{f} df.$$

The pairwise heterozygosity is therefore given by  
$$ H \sim \langle f(1-f) \rangle \sim \int_0^1 f(1-f) \frac{N\mu}{f} \sim N\mu. $$  
...
$$ H \sim \langle f(1-f) \rangle \sim \int_0^{1/Ns} f(1-f) \frac{N\mu}{f} \sim \frac{\mu}{s}. $$
