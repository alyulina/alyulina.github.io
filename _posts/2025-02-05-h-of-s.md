...
---  
<sup>1</sup> <sub><sup>In diploid organisms, heterozygosity often refers to the probability that two alleles at a locus differ in state _within an individual_, rather than across the population. If the dominance coefficient is $$1/2$$, the diploid system is equivalent to the haploid case considered here, with a rescaled population size. Other kinds of dominance fall outside our simple model.</sup></sub>  
