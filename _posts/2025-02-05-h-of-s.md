...
$$ p(f) df \sim \int \underbraceN\mu dt}_{\text{arises}} \cdot \underbrace{\frac{1}{t}}_{\text{survives}} \cdot \underbrace{\frac{N}{t} e^{-Nf/t}}_{\text{contributes}} df \sim \frac{N\mu}{f} df.$$
