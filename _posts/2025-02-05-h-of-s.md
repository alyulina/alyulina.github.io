...
$$ p(f) df \sim \int \underbracket{N\mu dt}_{\text{arises}} \cdot \underbracket{\frac{1}{t}}_{\text{survives}} \cdot \underbracket{\frac{N}{t} e^{-Nf/t}}_{\text{contributes}} df \sim \frac{N\mu}{f} df.$$
